...
_STRINGS: dict[str, tuple[str, str]] = {
    ...
    # ── Summary stats ──────────────────────────────────────────────────────
    "summary_statistics":       ("Summary Statistics",               "Estadísticas Resumidas"),
    "expected_irr":             ("Expected IRR",                     "TIR Esperada"),
    "expected_return":          ("Expected Return",                  "Rendimiento Esperado"),
    "prob_maturity":            ("Maturity Probability",             "Prob. Vencimiento"),
    "prob_floor":               ("Capital Floor Probability",        "Prob. Piso de Capital"),
    ...
    "call_3m":                  ("3M Call",                          "Ejercicio 3M"),
    "call_6m":                  ("6M Call",                          "Ejercicio 6M"),
    "call_9m":                  ("9M Call",                          "Ejercicio 9M"),
    "reaches_maturity":         ("Reaches Maturity",                 "Llega al Vencimiento"),
    "sim_complete":             ("Simulation complete.",             "Simulación completada."),

    # ── Tab labels ─────────────────────────────────────────────────────────
    "tab_payoff":               ("📊 Payoff & Distribution",         "📊 Rendimiento y Distribución"),
    ...
    "path_of":                  ("Path #{n} of {total}",            "Path #{n} de {total}"),
    "asset_price_paths":        ("Asset Price Paths — Path #{n}",   "Paths de Precios — Path #{n}"),
    "price_label":              ("Price",                            "Precio"),
    "time_step":                ("Time Step",                        "Paso de Tiempo"),
    "wof_path_title":           ("Worst-of Performance Path #{n}",  "Rendimiento Worst-of Path #{n}"),
    "nominal_payout":           ("Nominal Payout",                  "Rendimiento Nominal"),
    "annualised_return":        ("Annualised Return",               "Rendimiento Anualizado"),
    "called_label":             ("← Called",                        "← Llamado"),
    "continued_label":          ("(continued)",                     "(continúa)"),
    "outcome_called":           ("✅ Issuer called at {q}",         "✅ Emisor ejerció call en {q}"),
    ...
    "corr_caption":             (
        ...
        "Las correlaciones de **input** se estiman de datos históricos. "
        "Las correlaciones **realizadas** se calculan de los paths simulados — deben estar "
        "cerca de los inputs, validando la estructura de Cholesky.",
    ),
    "input_calibrated":         ("Input (Calibrated)",               "Input (Calibrado)"),
    "realized_simulated":       ("Realized (Simulated)",             "Realizada (Simulada)"),
    "diff_label":               ("Difference (Realized − Input)",    "Diferencia (Realizada − Input)"),
    ...
    "corr_warn":                ("Max off-diagonal error: **{v:.4f}** — consider increasing n_paths.",
                                 "Error máximo fuera de la diagonal: **{v:.4f}** — considere aumentar los paths de Monte Carlo."),
    ...
    "asset":                    ("Asset",                            "Activo"),
    "mu_label":                 ("μ (drift p.a.)",                  "μ (tendencia anual)"),
    "v0_label":                 ("V₀ (σ)",                          "V₀ (σ)"),
    ...
    "rho_note":                 (
        ...
        "**Nota sobre ρ (efecto leverage):** Los modelos canónicos asumen ρ ≈ −0.65 para SPX. "
    ...
    "backtest_failed":          ("Backtest failed: {e}",            "Backtest falló: {e}"),
    "backtest_no_results":      (
    ...
    "called_early":             ("Called Early",                    "Ejercicio Anticipado"),
    ...
    "outcome_called_3m":        ("Called at 3M",                    "Ejercicio en 3M"),
    "outcome_called_6m":        ("Called at 6M",                    "Ejercicio en 6M"),
    "outcome_called_9m":        ("Called at 9M",                    "Ejercicio en 9M"),
    "outcome_floor_applied":    ("Floor Applied",                   "Piso Aplicado"),
    ...
    "upside_detail":            ("Worst-of finished at **{perf:.1%}**, above the floor.",
                                 "El worst-of cerró en **{perf:.1%}**, por encima del floor."),
    "floor_detail":             ("Worst-of finished at **{perf:.1%}**, below the {floor:.0%} floor.",
                                 "El worst-of cerró en **{perf:.1%}**, por debajo del piso de {floor:.0%}."),
    "floor_info":               (
        "**{pct:.1%}** of simulated paths reach maturity with the worst-of below {floor:.0%}%, "
        "triggering the capital floor.",
        "**{pct:.1%}** de los paths simulados llegan al vencimiento con el worst-of por debajo de {floor:.0%}%, "
