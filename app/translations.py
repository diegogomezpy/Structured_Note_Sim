...
_STRINGS: dict[str, tuple[str, str]] = {
    ...
    "sidebar_branding_label":   ("Corporate branding (JSON) — optional",
                                 "Identidad corporativa (JSON) — opcional"),
    "sidebar_branding_help":    (
        "Upload a branding JSON to customise the PDF with your firm's colors and logo. "
        "Schema: {firm_name, primary_color, accent_color, logo_url}",
        "Cargue un JSON de identidad para personalizar el PDF con los colores y el logo de su "
        "firma. Esquema: {firm_name, primary_color, accent_color, logo_url}",
    ),
