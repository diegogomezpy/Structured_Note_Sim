...
_STRINGS: dict[str, tuple[str, str]] = {
    ...
    "redemption_axis":          ("Redemption (% of notional)",      "Redención (% del nominal)"),
    "lbl_par":                  ("Par",                             "Par"),
    "lbl_cap":                  ("Cap",                             "Tope"),
    # A/B comparison overlays
    "cmp_note_a":               ("Note A",                          "Nota A"),
    "cmp_note_b":               ("Note B",                          "Nota B"),
    "cmp_irr_dist":             ("IRR p.a. — A vs B",               "TIR anual — A vs B"),
    "cmp_irr_axis":             ("IRR p.a.",                        "TIR anual"),
    "cmp_pct_paths":            ("% of paths",                      "% de trayectorias"),
    "cmp_outcome":              ("Outcome — A vs B",                "Resultado — A vs B"),
    "cmp_redemption":           ("Redemption — A vs B",             "Reembolso — A vs B"),
    ...
    "autocalled_early":         ("Autocalled (early)",              "Autocancelado (anticipado)"),
    ...
    # A/B paired analytics
    "cmp_a_wins":                ("A ahead",                           "A por delante"),
    "cmp_b_wins":                ("B ahead",                           "B por delante"),
    "cmp_mean_edge":             ("mean",                              "media"),
    "cmp_delta_title":           ("Where B's edge comes from",         "De dónde viene la ventaja de B"),
    "cmp_delta_axis":            ("Mean edge (B − A)",                 "Ventaja media (B − A)"),
    "cmp_outcome_axis":          ("Outcome under A",                   "Resultado con A"),
    "cmp_edge_hover":            ("Mean edge",                         "Ventaja media"),
    "cmp_share_hover":           ("Share of paths",                    "Proporción de trayectorias"),
    ...
    "part_loss":                 ("Below par",                         "Bajo la par"),
    "part_par":                  ("At par",                            "A la par"),
    "part_gain":                 ("Above par",                         "Sobre la par"),
