...
export const S: Dict = {
  ...
  cover_metrics:      { en: 'Cover key terms', es: 'Términos clave de portada' },
  cover_metrics_hint: { en: 'Choose which figures appear in the at-a-glance rail on the summary page.', es: 'Elige qué cifras aparecen en el panel de resumen de la portada.' },
