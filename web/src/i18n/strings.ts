...
export const S: Dict = {
  ...
  rtour_welcome_t:  { en: 'Building a report', es: 'Crear un informe' },
  rtour_welcome_b:  { en: 'A quick tour of the report builder — choosing what goes in, branding it, and exporting the PDF.', es: 'Un recorrido rápido por el generador de informes: qué incluir, cómo aplicar la marca y exportar el PDF.' },
  rtour_presets_t:  { en: 'Start with a preset', es: 'Empieza con un preajuste' },
  rtour_presets_b:  { en: 'Pick an audience preset (Client, Term sheet, IC, Analyst…) to select a sensible set of sections in one click. Any manual change switches to “Custom”.', es: 'Elige un preajuste por audiencia (Cliente, Términos, CI, Analista…) para seleccionar un conjunto razonable de secciones con un clic. Cualquier cambio manual pasa a «Personalizado».' },
  rtour_sections_t: { en: 'Fine-tune the sections', es: 'Ajusta las secciones' },
  rtour_sections_b: { en: 'Toggle individual sections or whole groups on and off. The cover’s “In this report” list always matches what you include here.', es: 'Activa o desactiva secciones individuales o grupos completos. La lista «En este informe» de la portada siempre refleja lo que incluyas aquí.' },
  rtour_branding_t: { en: 'Brand it', es: 'Aplica tu marca' },
  rtour_branding_b: { en: 'Open Branding to set the firm name, logo, colours, fonts and cover art — or load a saved branding config. Everything is optional.', es: 'Abre Marca para definir el nombre, el logo, los colores, las fuentes y las imágenes de portada, o carga una configuración guardada. Todo es opcional.' },
  rtour_photos_t:   { en: 'Report photos', es: 'Fotos del informe' },
  rtour_photos_b:   { en: 'Upload your own photos or pick from the library. The first feeds the cover, the second the back page, and the rest fill empty space through the report.', es: 'Sube tus propias fotos o elígelas de la biblioteca. La primera va a la portada, la segunda a la contraportada y el resto rellenan los espacios vacíos del informe.' },
  rtour_metrics_t:  { en: 'Cover key terms', es: 'Términos de portada' },
  rtour_metrics_b:  { en: 'Choose exactly which figures appear in the summary page’s at-a-glance rail.', es: 'Elige exactamente qué cifras aparecen en el panel de resumen de la portada.' },
  rtour_generate_t: { en: 'Generate the PDF', es: 'Genera el PDF' },
  rtour_generate_b: { en: 'When you’re happy, generate the report — it downloads as a PDF. No simulation run is required for a terms-only report.', es: 'Cuando estés conforme, genera el informe: se descarga como PDF. No hace falta ejecutar la simulación para un informe solo de términos.' },
  rtour_done_t:     { en: 'You’re set', es: 'Listo' },
  rtour_done_b:     { en: 'That’s the report builder. Tweak, brand and export as many versions as you need.', es: 'Eso es el generador de informes. Ajusta, aplica tu marca y exporta tantas versiones como necesites.' },
