Copyright (c) 2026 Diego Gómez

This project is source-available under the PolyForm Shield License 1.0.0. In
short: you may use, copy, modify, and distribute the software for almost any
purpose — EXCEPT providing a product that competes with this software, or with
any product the licensor (or its affiliates) provides using it. The complete,
verbatim license text follows.

Required Notice: Copyright (c) 2026 Diego Gómez
