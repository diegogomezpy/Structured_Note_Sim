...
- **Bumping the tag is a production change.** Re-run
  ...
  LANGS — 30 today: 5 themes x {autocall, participation, position} x {en, es}). `scripts/pdf_baseline.py
